...
namespace ShaderLoader
{
    public static class UniformParser
    {
        ...
        internal static UniformInfo[] ParseUniformsFromShader(string shaderSource, List<string> errors = null)
        {
            ...
            return uniformDic.Select(x => new UniformInfo(x.Value, x.Key)).ToArray();
        }
    }
    ...
    public static class GlslParser
    {
            ...
            ShaderTargetPlatform target)
        {
            ...
            try
            {
                ...
                uniforms.AddRange(UniformParser.ParseUniformsFromShader(clean, errors));
            ...
            catch (Exception e)
            {
                ...
                return new ShaderParseResult(errors);
            }
        }
